...
namespace CarWebApi.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(CarSystemDBContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Employees
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Employee>>> GetEmployeeDB()
        {
        ...
        {
            return _context.EmployeeDB.Any(e => e.employee_Id == id);
        }
    }
}
